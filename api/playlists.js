...
// import { getPlaylistTrack } from "#db/queries/playlist_tracks"
...
router
    ...
    // const playlistTrack = await getPlaylistTrack(req.playlist.id, trackId);
    //     if(playlistTrack) return res.status(400).send("Duplicate track")
